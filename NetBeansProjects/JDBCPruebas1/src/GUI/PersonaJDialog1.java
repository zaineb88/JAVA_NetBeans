 ...
 * @author alumno2
 */
public class PersonaJDialog1 extends javax.swing.JDialog {

    /**
     * Creates new form PersonaJDialog1
     */
    public PersonaJDialog1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PersonaJDialog1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PersonaJDialog1 dialog = new PersonaJDialog1(new javax.swing.JFrame(), true);
